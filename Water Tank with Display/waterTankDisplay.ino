...
**
**  Modifications:
**   - le 24 mars 2016 => Ajout d'un écran oLed
**
**
******************************************************************************************************************************************************
*/
...
**        2 :  
**        3 :  
**        4 :  => Affichage oLed SDA
**        5 :  => Affichage oLed SCL
**
**       Digitales
**        0 :
**        1 :
...
**        GND
**        AREF
**        SDA :  => Affichage oLed SDA <== non utilisé car recouvert par le shield Ethernet
**        SLC :  => Affichage oLed SCL <== non utilisé car recouvert par le shield Ethernet
**       
**
******************************************************************************************************************************************************
*/
